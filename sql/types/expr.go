...
type GExpr interface {
	*ConstantExpr | *FieldExpr
	Eval(row Row) (*Value, error)
}

func foo[T GExpr](t T) {
}
...
func (c *ConstantExpr) Eval(row Row) (*Value, error) {
	return c.Value, nil
}
...
func (f *FieldExpr) Eval(row Row) (*Value, error) {
...
func (a *AndExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (n *NotExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (o *OrExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (e *EqualExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (g *GreatThanExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (i *IsNullExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (l *LessThanExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (a *AddExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (a *AssertExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (d *DivideExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (e *ExponentiateExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (f *FactorialExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (m *ModuloExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (m *MultiplyExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (n *NegateExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (s *SubtractExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
...
func (l *LikeExpr) Eval(row Row) (*Value, error) {
	panic("implement me")
}
